 ...
 * into account and also to maximize the odds of being able to reuse a recycled buffer, this class
 * is free to return buffers larger than the requested size. The caller needs to be able to
 * gracefully deal with getting buffers any size over the minimum.
 * <p>
