...
public abstract class AdapterComposite extends BaseAdapter implements
	...
	public final View getView(int position, View convertView, ViewGroup parent) {
		View res = getCompositeView(position, convertView, parent);
	 ...
	 * call {@link PinnedListView#tellNoMoreData()} if there is no more pages.
	 * 
	 * @param page
	 ...
	 * read: get view too
	 */
	public abstract View getCompositeView(int position, View convertView,
			ViewGroup parent);
